...
window.PATCH_DATA = {
  ...
  supports: [
    ...
    { name: "Infernal Legion III",  kind: "nerf",    icon: "s/infernallegion", chips: [{kind:"nerf", text:"from drop pool", removed: true}], desc: 'Can no longer be obtained.' },
    ...
    { name: "Overextend",           kind: "nerf",    icon: "s/overextend", chips: [{kind:"nerf", text:"from drop pool", removed: true}], desc: 'Can no longer be obtained.' },
    ...
    { name: "Shock Conduction II",  kind: "nerf",    icon: "s/conduction", chips: [{kind:"nerf", text:"from drop pool", removed: true}], desc: 'Can no longer be obtained.' },
