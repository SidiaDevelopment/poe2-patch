...
window.PATCH_DATA = {
  ...
  skills: [
    ...
    { name: "Time of Need",    tag: "Buff · Heal",          kind: "nerf",    icon: "TimeOfNeedSkill", chips: [{kind:"nerf", text:"lost Duration tag"}, {kind:"buff", text:"Interval", from:"11.3–10.1s", to:"9.3–8.1s"}, {kind:"buff", text:"uses cooldown rate"}], notes: ['Lost Duration tag — no longer scaled by Skill Duration.', 'Uses Cooldown Recovery.', 'Interval 9.3–8.1s (was 11.3–10.1).'] },
