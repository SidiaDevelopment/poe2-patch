...
window.PATCH_DATA = {
  ...
  skills: [
    ...
    { name: "Lunar Blessing",  tag: "Monk · Buff",          kind: "nerf",    icon: "DruidLunarBlessing", chips: [{kind:"nerf", text:"Moonbeams no longer melee"}], notes: ['Triggered Moonbeams are no longer melee skills.'] },
    ...
    { name: "Shred",           tag: "Ranger · Bleed",       kind: "buff",    icon: "DruidFrozenClaws", chips: [{kind:"buff", text:"Quality", from:"0–10% more AS", to:"0–20% increased AS"}], notes: ['Quality grants 0–20% increased Attack Speed (was 0–10% more).'] },
  ...
  supports: [
    ...
    { name: "Shock Conduction II",  kind: "nerf",    icon: "s/conduction", chips: [{kind:"nerf", text:"unobtainable"}], desc: 'Can no longer be obtained.' },
  ...
  uniqueReworks: [
    ...
    { name: "Apep's Supremacy", image: "Offhand/Foci/Uniques/ApepsSupremacy", chips: [{kind:"nerf", text:"lost 30–50% ES start"}], desc: 'No longer has 30–50% faster start of Energy Shield Recharge.' },
    ...
    { name: "Blackflame", image: "Rings/Uniques/Blackflame", chips: [{kind:"buff", text:"Ignite Mag", from:"50%", to:"80–100%"}, {kind:"nerf", text:"Ignite Dur", from:"−50%", to:"−60 to −75%"}, {kind:"neutral", text:"reworked"}], desc: 'No longer "Ignites take Chaos instead of Fire". Now: Withers also increase Fire Dmg taken, Ignites deal Chaos instead of Fire, Withered doesn\'t expire on Ignited enemies. Ignite Magnitude 80–100% (was 50%), Ignite duration on enemies −60 to −75% (was −50%).' },
    ...
    { name: "Seed of Cataclysm", image: "Rings/Uniques/SeedOfCataclysm", chips: [{kind:"nerf", text:"lost 30–50% Crit Spell Dmg"}, {kind:"buff", text:"Lucky Spell Crit Dmg"}], desc: 'No longer 30–50% increased Crit Spell Dmg Bonus. Now: 5% reduced Crit Spell Dmg Bonus per recent Spell crit; 15–30% chance for Spell Crit Damage to be Lucky.' },
