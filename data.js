...
window.PATCH_DATA = {
  ...
  uniqueReworks: [
    ...
    { name: "Blackflame", image: "Rings/Uniques/BlackFlameChaos", chips: [{kind:"buff", text:"Ignite Mag", from:"50%", to:"80–100%"}, {kind:"nerf", text:"Ignite Dur", from:"−50%", to:"−60 to −75%"}, {kind:"neutral", text:"reworked"}], desc: 'No longer "Ignites take Chaos instead of Fire". Now: Withers also increase Fire Dmg taken, Ignites deal Chaos instead of Fire, Withered doesn\'t expire on Ignited enemies. Ignite Magnitude 80–100% (was 50%), Ignite duration on enemies −60 to −75% (was −50%).' },
